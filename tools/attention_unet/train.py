...
def parse_args():
    p = argparse.ArgumentParser(description="Attention UNet Training")
    p.add_argument("--data_path", type=str, default=r"D:\resource\data\SS\AirbusShip_filtered_0.01")
    p.add_argument("--weight_path", type=str, default="params/attention_unet_ship.pth")
...
def main():
    ...
    logger.model_info("Attention_UNet", params, device)
