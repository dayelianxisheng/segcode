...
from model import SegFormer, CombinedLoss
...
def main():
    ...
    model = SegFormer(num_classes=1, phi=args.phi, pretrained=args.pretrained).to(device)
    model_name = f"SegFormer-{args.phi}"
